...
MACRO_CONFIG_STR(ClMapDownloadUrl, cl_map_download_url, 100, "https://raw.githubusercontent.com/NewTeeworldsCN/ddnet-maps7/refs/heads/main/outmaps", CFGFLAG_CLIENT | CFGFLAG_SAVE, "URL used to download maps (must start with https://)")
...
MACRO_CONFIG_INT(BrSort, br_sort, 2, 0, 256, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Sort criteria for the server browser")
...
MACRO_CONFIG_INT(GfxAsyncRender, gfx_asyncrender, 1, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Render asynchronously")
...
MACRO_CONFIG_INT(SvMaxClients, sv_max_clients, SERVER_MAX_CLIENTS, 1, SERVER_MAX_CLIENTS, CFGFLAG_SAVE | CFGFLAG_SERVER, "Maximum number of clients that are allowed on a server")
MACRO_CONFIG_INT(SvMaxClientsPerIP, sv_max_clients_per_ip, 4, 1, SERVER_MAX_CLIENTS, CFGFLAG_SAVE | CFGFLAG_SERVER, "Maximum number of clients with the same IP that can connect to the server")
...
MACRO_CONFIG_STR(SvDefaultLanguage, sv_default_language, 8, "en", CFGFLAG_SAVE | CFGFLAG_SERVER, "Server default language")
