...
public:
	...
	void Add(int Tick, int64_t Tagtime, int DataSize, const void *pData, bool CreateAlt);
	int Get(int Tick, int64_t *pTagtime, CSnapshot **ppData, CSnapshot **ppAltData) const;
};
