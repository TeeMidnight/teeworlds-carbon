...
MACRO_CONFIG_INT(ClOldStyleChat, cl_old_style_chat, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Using old style chat for DDNet players")
...
MACRO_CONFIG_INT(DbgDummies, dbg_dummies, 0, 0, SERVER_MAX_CLIENTS, CFGFLAG_SERVER, "")
#endif
