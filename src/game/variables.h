...
MACRO_CONFIG_INT(SvIdMapRefreshRate, sv_idmap_refresh_rate, 5, 0, 50, CFGFLAG_SAVE | CFGFLAG_SERVER, "The time to ban a player if kicked by vote. 0 makes it just use kick")
// debug
